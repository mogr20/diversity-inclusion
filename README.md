...
Testing included:
- Checking all links, including all links from and to each page. (e.g. checking tips, intro, links, works from the Diversity page)
- Viewing site layout and responsiveness (both portrait and landscape) on various devices.
- Checking external link card buttons.
